 ...
 *
 * Creation date: 6/12/2007
 * Contact: Priya Shivapura (for Syntricity, Inc)
 */

package util.boxandwhisker;
...
public class ExtendedBoxAndWhiskerRenderer extends BoxAndWhiskerRenderer {
    ...
    public void drawVerticalItem(Graphics2D g2, 
        ...
        if (!getItemVisible(row, column)) {
		 ...
		 List<Outlier> farOutValues = new ArrayList<Outlier>();
		 ...
		 if (yOutliers != null) {
		     ...
		     for (Iterator<Outlier> iterator = farOutValues.iterator(); iterator.hasNext();) {
		         Outlier outlier = (Outlier) iterator.next();
		         Point2D point = outlier.getPoint();		         
     ...
     * @param enity the entity collection.
     * @param dataset  the dataset.
